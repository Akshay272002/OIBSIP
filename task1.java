...
public class Task1 {
    ...
    public static class user {
        ...
        public String getUsername() {
            System.out.println(" Shubham Enter Username : ");
            username = sc.nextLine();
            return username;
        }

        public String getPassword() {
            System.out.println("Shubham Enter Password : ");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (Connection connection = DriverManager.getConnection(url, "root", "Root@123")) {
